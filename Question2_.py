...
df_infant_country = df_2015[['Infant mortality rate (probability of dying between birth and age 1 per 1000 live births)','Country']]
...
plt.title("Infant mortality rate by Country for 2015")


plt.savefig("Question2_")
